...
/* Private functions ---------------------------------------------------------*/
/**
  * @brief  This function is used to make sure that debug variables that are 
  *         unused in the application are not optimized away.  This function 
  *         might not be necessary for all compilers.  In this case, you should 
  *         simply DELETE the code in this function while still leaving the 
