...
/**
  ...
  * @param  pos     Position of interrupt vector in interrupt table :
  *
...
/**
  ...
  * @param  pos  Position of interrupt vector in interrupt table (see 'CPU_IntSrcDis()').
  * @retval None
  */
...
/**
  * @brief  Set priority of an interrupt source.
  * @param  pos   Position of interrupt vector in interrupt table (see 'CPU_IntSrcDis()').
...
/**
  * @brief  Get priority of an interrupt source.
  * @param  pos  Position of interrupt vector in interrupt table (see 'CPU_IntSrcDis()').
  * @retval Priority of interrupt source.  If the interrupt source specified is invalid, then
