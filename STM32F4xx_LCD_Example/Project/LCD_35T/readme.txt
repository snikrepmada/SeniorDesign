/**
  ...
  * @brief   Description of the STM32F4xx LCD display example.
  ******************************************************************************
  * @attention
  *
...
@par Example Description 
     ...
     This example project describes how to test LCD module on  STM32F4DIS-BB board.

     The red,green,blue ribbon appear on the LCD.

     The LCD driver support all bpp values. The example tests 16bpp.
