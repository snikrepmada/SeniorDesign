/* ---------------------------------------------------------------------- 
* Portions Copyright (C) 2010 ARM Limited. All rights reserved.   
*  
...
/**
  ...
  * @brief   This example shows how to use the Cortex-M4's FPU unit. 
  *          Modified to support the STM32F4DISCOVERY modules.   
  ******************************************************************************
  * @attention
  *
